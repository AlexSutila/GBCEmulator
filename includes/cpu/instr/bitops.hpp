...
public:
  ...
  std::string describe() override { return std::format("RLC {}", to_string<dst>()); }
};
...
public:
  ...
  std::string describe() override { return std::format("RL {}", to_string<dst>()); }
};
...
public:
  ...
  std::string describe() override { return std::format("RRC {}", to_string<dst>()); }
};
...
public:
  ...
  std::string describe() override { return std::format("RR {}", to_string<dst>()); }
};
...
public:
  ...
  std::string describe() override { return std::format("SLA {}", to_string<dst>()); }
};
...
public:
  ...
  std::string describe() override { return std::format("SWAP {}", to_string<dst>()); }
};
...
public:
  ...
  std::string describe() override { return std::format("SRL {}", to_string<dst>()); }
};
...
public:
  ...
  std::string describe() override { return std::format("BIT {}, HL", static_cast<int>(bit)); }
...
public:
  ...
  std::string describe() override { return std::format("RST {}, HL", static_cast<int>(bit)); }
  void parse() override { state = InstrStates::INSTR_STATE_READ; }
...
public:
  ...
  std::string describe() override { return std::format("SET {}, HL", static_cast<int>(bit)); }
  void parse() override { state = InstrStates::INSTR_STATE_READ; }
