...
public:
  ...
  std::string describe() override { return std::format("LD {}, HL", to_string<dst>()); }
...
public:
  ...
  std::string describe() override { return std::format("LD {}, HL", to_string<src>()); }
  std::size_t mem_access_t_cycle() override { return 4; }
};
...
public:
  ...
  std::string describe() override { return std::format("LD HL, {}", static_cast<int>(imm)); }
  void parse() override {
    const addr_t addr = reg_file->reg_pc++;
    imm = bus->read_byte(addr);
  }
...
public:
  ...
  std::string describe() override { return std::format("LD A, {}", to_string<src>()); }
  std::size_t mem_access_t_cycle() override { return 4; }
};
...
public:
  ...
  std::string describe() override { return std::format("LD A, {}", static_cast<int>(addr)); }
  void parse() override {
...
public:
  ...
  std::string describe() override { return std::format("LD {}, A", to_string<dst>()); }
  std::size_t mem_access_t_cycle() override { return 4; }
};
...
public:
  ...
  std::string describe() override { return std::format("LD {}, sp", static_cast<int>(addr)); }
  void parse() override {
    addr = bus->read_byte(reg_file->reg_pc++);
    addr |= static_cast<addr_t>(bus->read_byte(reg_file->reg_pc++)) << 8;
  }
...
public:
  ...
  std::string describe() override { return std::format("PUSH {}", to_string<src>()); }
  void parse() override {
...
public:
  ...
  std::string describe() override { return std::format("POP {}", to_string<dst>()); }
  void parse() override {
