#ifndef GBC_FETCHER_HPP
#define GBC_FETCHER_HPP
...
public:
  ...
  void step(); // Ignores sprites, follows BG/WIN fetch procedures only
...
private:
  ...
  [[nodiscard]] byte_t read_vram_byte(addr_t addr, byte_t bank) const;
