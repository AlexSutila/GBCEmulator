...
void APU::register_mmio() {
  ...
  for (std::size_t i = 0; i < wave_ram_size; ++i) {
    bus_.connect_mmio(
      static_cast<addr_t>(audio_base + audio_register_count +
  ...
  audio_registers[0x03].configure(0x00,
                                  [this](const byte_t value) {
                                    if (!apu_on_())
                                      return;
                                    nr13 = value;
  ...
  audio_registers[0x04].configure(
    ...
    [this](const byte_t value) {
      ...
      maybe_extra_length_clock(
        next_step_clocks_length(), prev_len_en, new_len_en,
  ...
  // FF15 (NR20) is unused.
  audio_registers[0x05].configure(0xFF, [](byte_t) {
  }, read_ff);
  ...
  audio_registers[0x08].configure(0x00,
                                  [this](const byte_t value) {
                                    if (!apu_on_())
                                      return;
                                    nr23 = value;
  ...
  audio_registers[0x0B].configure(0x00,
                                  [this](const byte_t v) {
                                    if (!apu_on_())
                                      return;
                                    nr31 = v;
  ...
  audio_registers[0x0D].configure(0x00,
                                  [this](const byte_t v) {
                                    if (!apu_on_())
                                      return;
                                    nr33 = v;
  ...
  // FF1F (NR40) is unused.
  audio_registers[0x0F].configure(0xFF, [](byte_t) {
  }, read_ff);

  // --- Channel 4 (NR41-NR44 / FF20-FF23) ---
  // NR41: write-only (read back as $FF)
  audio_registers[0x10].configure(0x00,
                                  [this](const byte_t v) {
                                    if (!apu_on_())
                                      return;
                                    nr41 = v;
                                    ch4_length_counter =
                                      static_cast<std::uint8_t>(64 - (v & 0x3F));
                                  },
                                  read_ff);
  ...
  audio_registers[0x12].configure(0x00,
                                  [this](const byte_t v) {
                                    if (!apu_on_())
                                      return;
                                    nr43 = v;
